    ...
    datasets: [
      {
        ...
        backgroundColor: ['#446b41', '#92c582', '#b2dfdb'],
        borderWidth: 1,
      },
    ],
  };
      ...
      <div className="row">
        ...
        <div className="col-lg-6 col-md-12 mb-3">
          <div className="card h-100">
            <div className="card-body">
              <h5 className="card-title">User, Book, and Request Count - Bar Chart</h5>
        ...
        <div className="col-lg-6 col-md-12 mb-3">
          <div className="card h-100">
            <div className="card-body">
              <h5 className="card-title">User, Book, and Request Count - Pie Chart</h5>
